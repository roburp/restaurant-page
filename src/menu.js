...
export default function addMenu() {
  ...
  const menuList = crEl("div", "", "menu-list");

  //menu-item-1
  const menuItem1 = crEl("div", "", "menu-item");
  //Item 1 Image
  ...
  //menu-item-2
  const menuItem2 = crEl("div", "", "menu-item");
  //Item 2 Image
  ...
  //menu-item-3
  const menuItem3 = crEl("div", "", "menu-item");
  //Item 3 Image
  ...
  //menu-item-4
  const menuItem4 = crEl("div", "", "menu-item");
  //Item 4 Image
  ...
  //menu-item-5
  const menuItem5 = crEl("div", "", "menu-item");
  //Item 5 Image
